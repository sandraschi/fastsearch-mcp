"""
FastSearch MCP Server - FastMCP 2.13 compliant implementation.

This module provides the main FastSearch MCP server implementation using FastMCP 2.13.
...
class FastSearchServer:
    """FastSearch MCP Server using FastMCP 2.13."""
    ...
    def _setup_tools(self) -> None:
        ...
        if not service_running:
            logger.warning(
                "FastSearch C++ service is not running. Tools will use fallback implementation."
            )
        ...
        for tool_class in AVAILABLE_TOOLS:
            try:
                ...
                if wrapper_creator:
                    ...
                    # Use lambda to properly capture tool_instance
                    def create_fallback_wrapper(instance):
                    ...
                    wrapper_func = create_fallback_wrapper(tool_instance)

                # Register the wrapper function with FastMCP 2.13
                self.app.tool(
                    name=tool_def.name,
