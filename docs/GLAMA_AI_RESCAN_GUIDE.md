...
# Go to: https://github.com/sandraschi/fastsearch-mcp/releases
...
**Subject**: "Request repository rescan for Gold status update - fastsearch-mcp"

**Message**:
```
Hello Glama.ai Team,

Our repository (sandraschi/fastsearch-mcp) has recently achieved Gold status
...
GitHub URL: https://github.com/sandraschi/fastsearch-mcp
...
curl -s "https://api.github.com/repos/sandraschi/fastsearch-mcp/releases/latest" | jq .published_at
...
1. **Repository Description**:
   ```
   FastMCP 2.13 compatible MCP server for fast NTFS file search - Gold Status Certified
   ```
