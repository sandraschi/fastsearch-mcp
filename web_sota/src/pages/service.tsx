        ...
        <CardContent className="space-y-4 text-xs text-slate-300">
          <div className="rounded-lg border border-slate-800 bg-slate-900/60 p-3 font-mono text-[11px] leading-relaxed text-slate-300">
            <div className="text-amber-400 font-semibold mb-1">
              Elevated Service Domain (Installed ONCE)
            </div>
            ...
            <div className="text-blue-400 my-1 font-sans font-medium text-center">
              ▲ IPC Named Pipe Connection (Local RPC) ▼
            </div>
            ...
            <div className="text-slate-400">
              ├── ZERO elevation required at runtime for searches
            </div>
            <div className="text-slate-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="rounded-md border border-slate-800 bg-slate-900/40 p-3 space-y-1">
              <div className="font-semibold text-slate-200">
                Elevated Engine (LocalSystem)
              </div>
              <p className="text-slate-400 leading-normal">
                Installed once as a Windows Service. Accesses raw volume handles
                (<code className="text-amber-200">\\.\C:</code>) to parse MFT
                file records directly without background indexing.
              </p>
            </div>
            <div className="rounded-md border border-slate-800 bg-slate-900/40 p-3 space-y-1">
              <div className="font-semibold text-slate-200">
              ...
              <p className="text-slate-400 leading-normal">
                The web application and MCP bridge run in normal user space. No
                admin prompts or elevated rights are needed when running queries
                over named pipes.
              </p>
            </div>
          </div>
