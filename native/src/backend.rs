...
const BACKEND_NAME: &str = "fastsearch-mcp-backend.exe";
const BACKEND_PORT: u16 = 10845;
const BACKEND_TAG: &str = "fastsearch-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "PORT";
const ENV_HOST: &str = "HOST";
const ENV_TAURI: &str = "FASTSEARCH_MCP_TAURI";
...
pub fn spawn_backend(app: AppHandle, state: &BackendProcess) -> Result<String, String> {
    ...
    log_line(
        &app,
        &format!("spawning {} (cwd {}) on port 10845",
